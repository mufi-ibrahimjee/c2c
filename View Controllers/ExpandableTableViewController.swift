...
class ExpandableTableViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,ExpandableHeaderViewDelegate {
    ...
    var sections = [
        ...
        Section(genre: "How many people can I have on my team?", movies: ["You can have 1 to 4 people per team. You should either create your own team or accept invitations from other team admins."], expanded: false),
        ...
        Section(genre: "What about accommodation for externals?", movies: ["We will not be providing any accomodation for external students. We expect our participants to stay at the venue for the full hack."], expanded: false)
    ]
